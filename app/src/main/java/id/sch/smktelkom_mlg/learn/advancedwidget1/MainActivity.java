...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttoProses).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        spJumlah.setOnItemClickListener(new AdapterView.OnItemSelectedListener()
        {
            @Override
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapaterView)
            {
                //
            }
        });
    ...
    private void doProses() {
        ...
        for (int i=0;i<10;i++)
        {
            ...
            EditText etUmur = (EditText) findViewById(R.id.editTextUmur);
